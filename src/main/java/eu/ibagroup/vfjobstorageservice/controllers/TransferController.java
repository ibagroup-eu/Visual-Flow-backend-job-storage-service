...
import eu.ibagroup.vfjobstorageservice.dto.importing.ImportRequestDto;
import eu.ibagroup.vfjobstorageservice.dto.importing.ImportResponseDto;
import eu.ibagroup.vfjobstorageservice.services.TransferService;
...
public class TransferController {
    ...
    public ExportResponseDto exportJobsPipelines(
    ...
    public ImportResponseDto importing(
        ...
        return transferService.importing(projectId, importRequestDto.getJobs(), importRequestDto.getPipelines());
    }
}
